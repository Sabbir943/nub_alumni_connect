...
const typeConfig = {
  ...
  call_outgoing: { icon: <FiPhone />, color: "text-emerald-500", bg: "bg-emerald-50 dark:bg-emerald-950/30", label: "Outgoing" },
        ...
        >
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            {unreadCount > 0 && (
              <button
                onClick={markAllRead}
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 text-sm font-semibold hover:bg-emerald-100 dark:hover:bg-emerald-950/50 transition-colors"
              >
                  ...
                  <motion.div
                    ...
                    className={`group relative bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border rounded-2xl p-4 md:p-5 transition-all hover:shadow-lg ${
                      notification.read
                        ...
                        : "border-emerald-200 dark:border-emerald-800/50 shadow-md shadow-emerald-100/50 dark:shadow-emerald-900/20"
                    }`}
                  >
                          ...
                          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            {!notification.read && (
                              <button
                                ...
                                className="p-1.5 rounded-lg text-zinc-400 hover:text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-950/30 transition-colors"
                                title="Mark as read"
                              >
